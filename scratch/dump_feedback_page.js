...
async function run() {
  try {
    ...
    console.log(`[4] Fetching feedback dashboard page...`);
    ...
    const destPath = path.join(__dirname, 'feedback_dashboard.html');
    fs.writeFileSync(destPath, fbRes.data);
    console.log(`[5] Saved feedback page HTML to: ${destPath}`);
