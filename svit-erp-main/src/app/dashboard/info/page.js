      ...
      <section className="grid" style={{ maxWidth: 800 }}>
        <article className="panel span-12">
          <div className="panel-head">
            ...
            <div className="avatar-placeholder" style={{ width: 48, height: 48, borderRadius: "50%", background: "var(--surface-strong)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.2rem", fontWeight: "bold", color: "var(--muted)" }}>
